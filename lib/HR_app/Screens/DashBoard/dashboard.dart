          ...
          child: Column(
            ...
            children: [
              ...
              Material(
                ...
                color: MyApp.isdarkmode.value == false ?Color(0xFFF5F4F9) : Theme.of(context).scaffoldBackgroundColor.withOpacity(0.1),
                child: Container(
                  height: 260,
                  ...
                  child: Column(
                    children: [
                      Container(
                        height: 56,
                        decoration: BoxDecoration(
                          color: MyApp.isdarkmode.value == false ?Colors.white : Theme.of(context).scaffoldBackgroundColor..withOpacity(0.1),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Row(
                          ...
                          Expanded(
                            ...
                            child: CircularPercentIndicator(
                              ...
                              center: CircularPercentIndicator(
                                ...
                                backgroundColor: Colors.grey[200],
                                percent: 0.50,
                                progressColor: Color(0XFF4CD3A3).withOpacity(0.8),
                                circularStrokeCap: CircularStrokeCap.round,
                                animation: true,
                                // center:
                              ),
